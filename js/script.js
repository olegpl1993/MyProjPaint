...
document.querySelector(".workSpace").innerHTML = `<canvas id="c1" width="${cWidth - 3}px" height="${cHight - 3}px"></canvas>`;
...
document.querySelector(".hideBtn").addEventListener('click', () => {
  document.querySelector(".panel").classList.toggle('invizPanel');
  document.querySelector(".hideBtn").classList.toggle('invizBtn');
});
